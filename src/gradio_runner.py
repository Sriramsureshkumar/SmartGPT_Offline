...
def go_gradio(**kwargs):
    ...
    demo = gr.Blocks(theme=theme, css=css_code, title="Leyland SmartGPT", analytics_enabled=False)
    ...
    no_model_msg = 'Leyland SmartGPT [   !!! Please Load Model in Models Tab !!!   ]'
    output_label0 = f'Leyland SmartGPT [Model: {kwargs.get("base_model")}]' if kwargs.get(
    ...
    with demo:
        ...
        def chatbot_list(x, model_used_in):
            return gr.Textbox(label=f'Leyland SmartGPT [Model: {model_used_in}]')
